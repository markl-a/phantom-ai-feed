...
- Public package metadata includes Apache-2.0 classifier, Python 3.11 classifier, and GitHub project URLs.
- CI installs the package, builds a wheel, runs the full test suite, and runs the deterministic no-network demo-loop smoke.
...
- See `docs/OPEN_SOURCE_READINESS.md` for current test evidence.
- See `docs/FINAL_RELEASE_AUDIT.md` for scan and dependency/license evidence.
